...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      confirmar_email_usuario: { Args: { p_token: string }; Returns: boolean }
    }
    Enums: {
      [_ in never]: never
    }
...
//   token_confirmacao: uuid (nullable, default: gen_random_uuid())
// Table: widgets
//   id: uuid (not null, default: gen_random_uuid())
//   cliente_id: uuid (nullable)
...
// --- DATABASE FUNCTIONS ---
// FUNCTION confirmar_email_usuario(uuid)
...
//   $function$
//
// FUNCTION handle_delete_usuario_cliente()
...
// --- TRIGGERS ---
// Table: usuarios_cliente
//   on_usuario_cliente_deleted: CREATE TRIGGER on_usuario_cliente_deleted BEFORE DELETE ON public.usuarios_cliente FOR EACH ROW EXECUTE FUNCTION handle_delete_usuario_cliente()
